    ...
    import Step1Icon from '../assets/images/step1-icon.png';
    import Step2Icon from '../assets/images/step2-icon.png';
    import Step3Icon from '../assets/images/step3-icon.png';
    import DoctorImage from '../assets/images/doctor-image.png'; // Assuming you have a similar path for the doctor's image
  ...
  <div class="flex flex-col justify-between">
    ...
    <div>
      ...
      <p>Have a virtual consultation with one of our certified specialists, or go for a physical visit to the doctor in case you opted for a physical check-up.</p>
            ...
            <div className="flex-1 md:max-w-xs mt-12 md:mt-0">
            <img src={DoctorImage} alt="Doctor" className="max-w-full rounded-lg shadow"/>
            </div>
        </div>
        </div>
    );
